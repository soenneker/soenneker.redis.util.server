...
public static class RedisServerUtilRegistrar
{
    ...
    {
        services.AddRedisUtilAsSingleton().AddRedisServerClientAsSingleton().TryAddSingleton<IRedisServerUtil, RedisServerUtil>();
    ...
    {
        services.AddRedisUtilAsSingleton().AddRedisServerClientAsSingleton().TryAddScoped<IRedisServerUtil, RedisServerUtil>();
